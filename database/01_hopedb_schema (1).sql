-- =====================================================
-- HopeDB Schema + Actual Data  -  Script 01
-- Hope, Inc. Database
-- Conceptualized by JEREMIAS C. ESPERANZA - NEU CCS
-- Information Management Course
-- =====================================================
-- Run this script FIRST on a brand-new Supabase project.
-- After this, run 02 → 03 → 04 → 05 → 07 in order.
--
-- This script is self-contained:
--   • Drops existing business tables (safe to re-run)
--   • Creates all 10 HopeDB tables
--   • Inserts the professor's full actual dataset
--   • Sets initial record_status / stamp audit values
--   • Enables RLS on product and pricehist
-- =====================================================


-- =====================================================
-- Drop existing business tables (reverse FK order)
-- Safe to run on a fresh DB (IF EXISTS ignores missing tables)
-- =====================================================
...
-- product and pricehist include app-specific columns
-- (record_status, stamp) so no ALTER TABLE is needed later.
-- =====================================================
...
CREATE TABLE sales (
  ...
  salesdate DATE,
  custno    VARCHAR(5) REFERENCES customer,
...
CREATE TABLE salesdetail (
  ...
  quantity DECIMAL(10,2) CHECK (quantity >= 0.0),
...
INSERT INTO department VALUES ('BR1','Sales Branch 1');
INSERT INTO department VALUES ('BR2','Sales Branch 2');
INSERT INTO department VALUES ('EXC','Executive');
INSERT INTO department VALUES ('HRD','Human Resource');
INSERT INTO department VALUES ('IT', 'Information Tech');
INSERT INTO department VALUES ('PAY','Payroll');
INSERT INTO department VALUES ('WHS','Warehouse');
...
INSERT INTO jobhistory VALUES ('00063','SA1', '2011-01-05', 36000,'BR2');
...
INSERT INTO customer VALUES ('C0066','Helen Strong',         '800 S Main St Tulelake, CA 96134',          'COD');
...
INSERT INTO product VALUES ('NT0005','Samsung Galaxy Tab32G',  'ea');
...
-- PAYMENT (165 rows)
INSERT INTO payment VALUES ('OR000001','2010-06-20',3284.70,  'TR000001');
INSERT INTO payment VALUES ('OR000002','2010-07-05',1581.72,  'TR000002');
INSERT INTO payment VALUES ('OR000003','2010-07-05',7.50,     'TR000003');
...
INSERT INTO payment VALUES ('OR000006','2010-07-10',3000.00,  'TR000004');
INSERT INTO payment VALUES ('OR000007','2010-07-10',309.22,   'TR000009');
INSERT INTO payment VALUES ('OR000008','2010-07-12',1393.00,  'TR000012');
INSERT INTO payment VALUES ('OR000009','2010-07-12',740.97,   'TR000015');
INSERT INTO payment VALUES ('OR000010','2010-07-15',1000.00,  'TR000006');
INSERT INTO payment VALUES ('OR000011','2010-07-20',1000.00,  'TR000010');
INSERT INTO payment VALUES ('OR000012','2010-07-20',1500.00,  'TR000011');
INSERT INTO payment VALUES ('OR000013','2010-07-27',2000.00,  'TR000016');
INSERT INTO payment VALUES ('OR000014','2010-08-01',403.02,   'TR000013');
INSERT INTO payment VALUES ('OR000015','2010-08-01',500.00,   'TR000014');
INSERT INTO payment VALUES ('OR000016','2010-08-01',4000.00,  'TR000018');
INSERT INTO payment VALUES ('OR000017','2010-08-05',907.50,   'TR000020');
INSERT INTO payment VALUES ('OR000018','2010-08-07',1095.00,  'TR000006');
INSERT INTO payment VALUES ('OR000019','2010-08-10',1000.00,  'TR000008');
INSERT INTO payment VALUES ('OR000020','2010-08-10',300.00,   'TR000023');
...
INSERT INTO payment VALUES ('OR000023','2010-08-12',1000.00,  'TR000017');
...
INSERT INTO payment VALUES ('OR000027','2010-08-20',700.40,   'TR000004');
INSERT INTO payment VALUES ('OR000028','2010-08-23',608.96,   'TR000019');
INSERT INTO payment VALUES ('OR000029','2010-08-30',1000.00,  'TR000022');
INSERT INTO payment VALUES ('OR000030','2010-08-30',623.25,   'TR000027');
INSERT INTO payment VALUES ('OR000031','2010-09-01',500.00,   'TR000021');
INSERT INTO payment VALUES ('OR000032','2010-09-05',498.59,   'TR000028');
INSERT INTO payment VALUES ('OR000033','2010-09-05',429.00,   'TR000031');
INSERT INTO payment VALUES ('OR000034','2010-09-06',900.00,   'TR000033');
INSERT INTO payment VALUES ('OR000035','2010-09-06',718.50,   'TR000034');
INSERT INTO payment VALUES ('OR000036','2010-09-10',337.50,   'TR000029');
...
INSERT INTO payment VALUES ('OR000039','2010-09-20',1000.00,  'TR000032');
INSERT INTO payment VALUES ('OR000040','2010-09-20',4000.00,  'TR000035');
INSERT INTO payment VALUES ('OR000041','2010-09-30',1000.00,  'TR000030');
INSERT INTO payment VALUES ('OR000042','2010-09-30',4000.00,  'TR000036');
INSERT INTO payment VALUES ('OR000043','2010-09-30',1000.00,  'TR000038');
...
INSERT INTO payment VALUES ('OR000047','2010-10-10',3417.20,  'TR000037');
INSERT INTO payment VALUES ('OR000048','2010-10-23',917.44,   'TR000038');
INSERT INTO payment VALUES ('OR000049','2010-10-23',2000.00,  'TR000039');
INSERT INTO payment VALUES ('OR000050','2010-10-25',3000.00,  'TR000040');
INSERT INTO payment VALUES ('OR000051','2010-10-30',522.68,   'TR000042');
INSERT INTO payment VALUES ('OR000052','2010-11-10',1470.00,  'TR000040');
INSERT INTO payment VALUES ('OR000053','2010-11-20',959.30,   'TR000039');
INSERT INTO payment VALUES ('OR000054','2010-11-20',2000.00,  'TR000043');
INSERT INTO payment VALUES ('OR000055','2010-11-20',219.00,   'TR000047');
INSERT INTO payment VALUES ('OR000056','2010-12-01',1503.60,  'TR000044');
INSERT INTO payment VALUES ('OR000057','2010-12-05',3000.00,  'TR000045');
INSERT INTO payment VALUES ('OR000058','2010-12-10',3294.99,  'TR000046');
INSERT INTO payment VALUES ('OR000059','2010-12-10',6249.50,  'TR000049');
...
INSERT INTO payment VALUES ('OR000062','2011-01-02',1500.00,  'TR000048');
INSERT INTO payment VALUES ('OR000063','2011-01-05',5000.00,  'TR000051');
INSERT INTO payment VALUES ('OR000064','2011-01-15',1516.26,  'TR000048');
INSERT INTO payment VALUES ('OR000065','2011-01-15',5000.00,  'TR000051');
INSERT INTO payment VALUES ('OR000066','2011-01-15',599.99,   'TR000063');
INSERT INTO payment VALUES ('OR000067','2011-01-20',399.90,   'TR000068');
INSERT INTO payment VALUES ('OR000068','2011-01-20',425.00,   'TR000069');
INSERT INTO payment VALUES ('OR000069','2011-01-25',1237.47,  'TR000070');
INSERT INTO payment VALUES ('OR000070','2011-01-25',287.00,   'TR000071');
INSERT INTO payment VALUES ('OR000071','2011-01-25',499.99,   'TR000072');
INSERT INTO payment VALUES ('OR000072','2011-01-30',10000.00, 'TR000053');
INSERT INTO payment VALUES ('OR000073','2011-01-30',1371.02,  'TR000062');
INSERT INTO payment VALUES ('OR000074','2011-01-30',5000.00,  'TR000066');
INSERT INTO payment VALUES ('OR000075','2011-02-01',1000.00,  'TR000054');
INSERT INTO payment VALUES ('OR000076','2011-02-01',3000.00,  'TR000058');
INSERT INTO payment VALUES ('OR000077','2011-02-02',2369.44,  'TR000077');
INSERT INTO payment VALUES ('OR000078','2011-02-05',5000.00,  'TR000052');
INSERT INTO payment VALUES ('OR000079','2011-02-05',3000.00,  'TR000055');
...
INSERT INTO payment VALUES ('OR000082','2011-02-07',1500.00,  'TR000080');
INSERT INTO payment VALUES ('OR000083','2011-02-10',5374.40,  'TR000052');
INSERT INTO payment VALUES ('OR000084','2011-02-10',5654.20,  'TR000053');
INSERT INTO payment VALUES ('OR000085','2011-02-10',2314.99,  'TR000054');
INSERT INTO payment VALUES ('OR000086','2011-02-10',2015.00,  'TR000058');
INSERT INTO payment VALUES ('OR000087','2011-02-10',2624.70,  'TR000059');
INSERT INTO payment VALUES ('OR000088','2011-02-10',2043.81,  'TR000060');
INSERT INTO payment VALUES ('OR000089','2011-02-10',1500.00,  'TR000061');
...
INSERT INTO payment VALUES ('OR000092','2011-02-15',6451.80,  'TR000064');
...
INSERT INTO payment VALUES ('OR000096','2011-02-15',3000.00,  'TR000083');
INSERT INTO payment VALUES ('OR000097','2011-02-17',6935.80,  'TR000066');
...
INSERT INTO payment VALUES ('OR000101','2011-02-25',7000.00,  'TR000078');
INSERT INTO payment VALUES ('OR000102','2011-02-25',2054.16,  'TR000080');
INSERT INTO payment VALUES ('OR000103','2011-02-25',7000.00,  'TR000088');
INSERT INTO payment VALUES ('OR000104','2011-02-25',5000.00,  'TR000089');
INSERT INTO payment VALUES ('OR000105','2011-02-26',3000.00,  'TR000081');
INSERT INTO payment VALUES ('OR000106','2011-03-01',10000.00, 'TR000073');
INSERT INTO payment VALUES ('OR000107','2011-03-01',4000.00,  'TR000087');
...
INSERT INTO payment VALUES ('OR000112','2011-03-05',3000.00,  'TR000084');
...
INSERT INTO payment VALUES ('OR000115','2011-03-05',858.40,   'TR000096');
INSERT INTO payment VALUES ('OR000116','2011-03-10',7000.00,  'TR000088');
INSERT INTO payment VALUES ('OR000117','2011-03-10',6847.20,  'TR000089');
INSERT INTO payment VALUES ('OR000118','2011-03-11',13200.22, 'TR000073');
INSERT INTO payment VALUES ('OR000119','2011-03-15',3000.00,  'TR000086');
INSERT INTO payment VALUES ('OR000120','2011-03-15',3489.29,  'TR000098');
INSERT INTO payment VALUES ('OR000121','2011-03-15',3000.00,  'TR000100');
INSERT INTO payment VALUES ('OR000122','2011-03-20',2923.67,  'TR000088');
INSERT INTO payment VALUES ('OR000123','2011-03-20',2000.00,  'TR000092');
INSERT INTO payment VALUES ('OR000124','2011-03-20',4000.00,  'TR000093');
INSERT INTO payment VALUES ('OR000125','2011-03-20',1500.00,  'TR000097');
...
INSERT INTO payment VALUES ('OR000128','2011-03-30',3000.00,  'TR000100');
...
INSERT INTO payment VALUES ('OR000131','2011-04-05',1787.00,  'TR000097');
INSERT INTO payment VALUES ('OR000132','2011-04-05',5000.00,  'TR000102');
INSERT INTO payment VALUES ('OR000133','2011-04-05',3000.00,  'TR000103');
INSERT INTO payment VALUES ('OR000134','2011-04-05',2000.00,  'TR000106');
...
INSERT INTO payment VALUES ('OR000137','2011-04-07',850.00,   'TR000110');
INSERT INTO payment VALUES ('OR000138','2011-04-07',2369.44,  'TR000111');
INSERT INTO payment VALUES ('OR000139','2011-04-07',600.00,   'TR000112');
...
INSERT INTO payment VALUES ('OR000146','2011-04-10',3000.00,  'TR000100');
INSERT INTO payment VALUES ('OR000147','2011-04-10',4000.00,  'TR000103');
...
INSERT INTO payment VALUES ('OR000151','2011-04-20',5923.60,  'TR000105');
INSERT INTO payment VALUES ('OR000152','2011-04-20',20000.00, 'TR000119');
INSERT INTO payment VALUES ('OR000153','2011-04-20',30000.00, 'TR000120');
INSERT INTO payment VALUES ('OR000154','2011-04-30',3000.00,  'TR000104');
INSERT INTO payment VALUES ('OR000155','2011-04-30',2738.88,  'TR000106');
INSERT INTO payment VALUES ('OR000156','2011-04-30',5923.60,  'TR000107');
INSERT INTO payment VALUES ('OR000157','2011-04-30',20000.00, 'TR000123');
INSERT INTO payment VALUES ('OR000158','2011-05-01',20000.00, 'TR000119');
INSERT INTO payment VALUES ('OR000159','2011-05-05',30000.00, 'TR000120');
INSERT INTO payment VALUES ('OR000160','2011-05-10',37494.40, 'TR000119');
INSERT INTO payment VALUES ('OR000161','2011-05-15',17872.99, 'TR000124');
INSERT INTO payment VALUES ('OR000162','2011-05-20',21898.90, 'TR000123');
INSERT INTO payment VALUES ('OR000163','2011-05-30',43708.17, 'TR000120');
INSERT INTO payment VALUES ('OR000164','2011-05-30',12804.30, 'TR000121');
INSERT INTO payment VALUES ('OR000165','2011-05-30',27587.77, 'TR000122');

-- PRICEHIST (79 rows)
INSERT INTO pricehist VALUES ('2010-05-15','AK0001',12.00);
...
INSERT INTO pricehist VALUES ('2010-05-15','MD0005',825.00);
INSERT INTO pricehist VALUES ('2010-05-15','MD0006',124.29);
INSERT INTO pricehist VALUES ('2010-05-15','NB0001',300.00);
INSERT INTO pricehist VALUES ('2010-05-15','NB0002',298.00);
INSERT INTO pricehist VALUES ('2010-05-15','NB0003',199.00);
INSERT INTO pricehist VALUES ('2010-05-15','NB0004',279.00);
INSERT INTO pricehist VALUES ('2010-05-15','PA0001',219.00);
...
INSERT INTO pricehist VALUES ('2010-05-15','PC0003',390.00);
INSERT INTO pricehist VALUES ('2010-05-15','PC0004',538.00);
...
INSERT INTO pricehist VALUES ('2010-05-15','PF0005',119.00);
INSERT INTO pricehist VALUES ('2010-05-15','PF0006',7.50);
INSERT INTO pricehist VALUES ('2010-05-15','PR0001',81.72);
INSERT INTO pricehist VALUES ('2010-05-15','PR0002',99.99);
INSERT INTO pricehist VALUES ('2010-05-15','PR0003',123.00);
...
INSERT INTO pricehist VALUES ('2010-08-01','MD0005',907.50);
INSERT INTO pricehist VALUES ('2010-08-01','MD0006',136.72);
INSERT INTO pricehist VALUES ('2010-08-16','PF0001',112.50);
...
INSERT INTO pricehist VALUES ('2010-08-16','AP0002',319.70);
INSERT INTO pricehist VALUES ('2010-08-16','AP0003',367.49);
INSERT INTO pricehist VALUES ('2010-08-16','AD0001',58.00);
...
INSERT INTO pricehist VALUES ('2010-12-01','NT0003',287.00);
...
INSERT INTO pricehist VALUES ('2010-12-01','PS0001',3200.00);
...
INSERT INTO pricehist VALUES ('2010-12-01','MP0003',425.00);
INSERT INTO pricehist VALUES ('2010-12-01','MP0004',302.00);
INSERT INTO pricehist VALUES ('2011-02-01','NB0005',1184.72);


-- =====================================================
-- Set initial audit values
-- (record_status and stamp are already defined in the
--  CREATE TABLE statements above; just seed the data)
-- =====================================================
...
-- Policies are applied by 04_rls_policies.sql and
