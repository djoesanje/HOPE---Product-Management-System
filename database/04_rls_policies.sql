...
-- Safe to re-run: all CREATE POLICY statements are
...
DROP POLICY IF EXISTS user_select_all_for_admin    ON "user";
...
-- -------------------------------------------------------
DROP POLICY IF EXISTS module_select_all ON Module;
...
-- -------------------------------------------------------
DROP POLICY IF EXISTS user_module_select_own           ON user_module;
DROP POLICY IF EXISTS user_module_select_all_for_admin ON user_module;
...
-- -------------------------------------------------------
DROP POLICY IF EXISTS rights_select_all ON rights;
...
-- -------------------------------------------------------
DROP POLICY IF EXISTS usermodule_rights_select_own           ON UserModule_Rights;
DROP POLICY IF EXISTS usermodule_rights_select_all_for_admin ON UserModule_Rights;
...
-- -------------------------------------------------------
DROP POLICY IF EXISTS product_select_active_for_user ON product;
DROP POLICY IF EXISTS product_insert_with_right      ON product;
...
-- -------------------------------------------------------
DROP POLICY IF EXISTS pricehist_select_active        ON priceHist;
